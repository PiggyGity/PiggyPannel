...
$router->get('/payment/mercadopago/notification', 'InvoiceController:notifications', 'web.invoice.notifications');
$router->post('/payment/mercadopago/notification', 'InvoiceController:notifications', 'web.invoice.notifications');
