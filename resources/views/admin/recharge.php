...
<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
    ...
    <div class="content flex-row-fluid" id="kt_content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <!--begin::Calendar-->
                <form action="<?= $r->route('admin.recharge.send.byuser') ?>" method="post">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-6">
                                <!--begin::Block-->
                                <label for="" class="required form-label">Quantidade:</label>
                                <input type="text" class="form-control form-control-solid" placeholder="Quantidade de cupons" id="ammount" name="ammount" />
                                <!--end::Block-->
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <button type="submit" class="btn btn-primary" style="width:100%;">Enviar recarga</button>
                        </div>
                    </div>
                </form>
                <!--end::Calendar-->
