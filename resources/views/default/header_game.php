    ...
    <div class="container d-flex align-items-center">
        ...
        <div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
            <a href="<?= base_url("lobby") ?>">
                <img alt="Logo" src="https://media.discordapp.net/attachments/668534332020752395/872661975652528248/11.png" class="logo-default h-25px" style=" width: 35px; height: 35px!important; ">
                <img alt="Logo" src="https://media.discordapp.net/attachments/668534332020752395/872661975652528248/11.png" class="logo-sticky h-25px" style=" width: 35px; height: 35px!important; ">
            </a>
        </div>
                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
                    ...
                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
                            <a class="menu-link py-3" target="_blank" href="<?= $r->route('web.lobby') ?>">
                                <span class="menu-title">Home</span>
                                <span class="menu-arrow d-lg-none"></span>
                            </a>
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                <div class="menu-item">
                                    <a class="menu-link py-3" target="_blank" href="<?= $r->route('web.landing') ?>">
                        ...
                        <div class="btn me-lg-1 btn-danger">
                            <a class="menu-link py-3 text-white" href="roadclient://<?= 'https://res.orangetank.com.br/flash/Loading.swf?user=' . $uname . '&key=' . $hash . '&config=' . base_url('/') . 'config.xml' ?>">
                                <span class="menu-title">ABRI com lAUCHER ddtank3.exe</span>
                                <span class="menu-arrow d-lg-none"></span>
                            </a>
                            </div>
                        <?php if ($udata->type == 7) : ?>
                                ...
                                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                            <div class="menu-item">
                                                <a class="menu-link py-3" target="_blank" href="<?= $r->route('admin.user.list') ?>">
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                            <div class="menu-item">
                                                <a class="menu-link py-3" href="<?= $r->route('admin.product.list') ?>">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                            ...
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3" target="_blank" href="<?= $r->route('web.account.settings') ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3" target="_blank" href="<?= $r->route('web.account.purchases.history') ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div class="menu-item">
                                            <a class="menu-link py-3" target="_blank" href="<?= $r->route('web.recharge') ?>">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Acessar loja</span>
                                            </a>
                                        </div>
                                        <div class="menu-item">
                                            <a class="menu-link py-3" target="_blank" href="<?= $r->route('web.account.purchases.history') ?>">
                                                ...
                                                <span class="menu-title">Historico de compras</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
                            ...
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="<?= $r->route('web.recharge') ?>" target="_blank" title="adquirir cupons" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="javascript:;" title="Em breve" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                        ...
                                        <span class="menu-title">Pacotes vip</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="layout-builder.html" title="Em breve" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                        ...
                                        <span class="menu-title">Membro ouro</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex align-items-center me-n3 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-5">
                                <a href="<?= $r->route('web.account.settings') ?>" target="_blank" class="menu-link px-5">Meu perfil</a>
                            </div>
                            <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start" data-kt-menu-flip="bottom">
                                ...
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    <div class="menu-item px-3">
                                        <a href="<?= $r->route('web.account.purchases.history') ?>" target="_blank" class="menu-link px-5">Minhas compras</a>
                                    </div>
                                    <div class="menu-item px-3">
                                        <a href="javascrips:;" class="menu-link px-5">Ajuda</a>
                                    </div>
                                    <div class="menu-item px-3">
                                        <a href="<?= $r->route('web.recharge') ?>" target="_blank" class="menu-link px-5">Comprar</a>
                                    </div>
                                    <div class="separator my-2"></div>
                                    <div class="menu-item px-3">
