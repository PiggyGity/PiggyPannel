...
<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-white fw-bolder my-1 fs-3">Pacote cupons</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            ...
            <div class="card-body p-lg-20">
                ...
                <div class="d-flex flex-column flex-xl-row">
                    ...
                    <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
                        ...
                        <div class="mt-n1">
                            <!--begin::Top-->
                            <div class="d-flex pb-10" style="align-items: center;">
                                <!--begin::Logo
                                <a href="#">
                            ...
                            <div class="m-0">
                                <!--begin::Label-->
                                <div class="fw-bolder fs-3 text-gray-800 mb-8">Pacote cupons</div>
                                <!--end::Label-->
                                <!--begin::Row-->
                                ...
                                <div class="row g-5 mb-12">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <!--end::Text-->
                                        <!--end::Description-->
                                        <div class="fw-bold fs-7 text-gray-600">pagamento via <span class="text-gray-800">MercadoPago & PicPay</span></div>
                                        <!--end::Description-->
                                    </div>
                                    <!--end::Col-->
                                </div>
                    ...
                    <div class="m-0">
                        ...
                        <div class="d-print-none border border-dashed border-gray-300 card-rounded h-lg-100 min-w-md-350px p-9 bg-lighten">
                            ...
                            <div class="mb-6"> 
                            <a href="<?= base_url("fatura/create/{$product_data->id}/mercadopago") ?>" class="btn btn-sm btn-primary">Pagar com mercadopago</a>
                                <a href="<?= base_url("fatura/create/{$product_data->id}/picpay") ?>" class="btn btn-sm btn-success">Pagar com picpay</a>
                            </div>
                        </div>
