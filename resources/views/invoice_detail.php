                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="fw-bolder fs-6 text-gray-800 d-flex align-items-center flex-wrap">
                                                ...
                                                <span class="fs-7 text-danger d-flex align-items-center">
                                                    <span class="bullet bullet-dot bg-danger me-2"></span><?= timeAgo(strtotime($invoice_data->updated_at)) ?></span>
                                            </div>
                                            <!--end::Info-->
                                        </div>
                                        <!--end::Col-->
                                ...
                                <div class="row g-5 mb-12">
                                    ...
                                    <?php if ($invoice_data->created_at != $invoice_data->updated_at) : ?>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <!--end::Label-->
                                            <!--end::Text-->
                                            <div class="fw-bolder fs-6 text-gray-800"><?= ($invoice_data->method == 'mercado_pago') ? 'MercadoPago' : 'PicPay' ?>.</div>
                                            <!--end::Text-->
                                            <!--end::Description-->
